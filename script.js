    ...
    <article class="product-card reveal">
      ...
      <div class="product-body">
        ...
        <div class="product-actions">
          ...
          <a class="btn btn-whatsapp btn-whatsapp--stacked" href="${buildWhatsappLink(p.whatsappMessage)}" target="_blank" rel="noopener">
            <span class="btn-wa-main">CHAT WHATSAPP</span>
            <span class="btn-wa-sub">UNTUK TANYA HARGA, PROMO, SIMULASI KREDIT, DAN INFO LEBIH LANJUT</span>
          </a>
        </div>
      </div>
    </article>
